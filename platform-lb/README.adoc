...
Edit file _k8s/confluent-platform-reducted.yaml_ and add the value of your Kubernetes cluster DOMAIN (default is _cluster.local_)
...
Open a browser poiting to http://controlcenter.$DOMAIN (e.g.http://controlcenter.cluster.local)
